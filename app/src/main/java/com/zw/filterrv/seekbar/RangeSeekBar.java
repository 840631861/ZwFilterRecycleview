package com.zw.filterrv.seekbar;
...
//    private float maxPositiveValue, minPositiveValue;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //draw left SeekBar
        if (leftSB.getIndicatorShowMode() == SeekBar.INDICATOR_MODE_ALWAYS_SHOW){
        ...
        //draw right SeekBar
        if (rightSB != null) {
            if (rightSB.getIndicatorShowMode() == SeekBar.INDICATOR_MODE_ALWAYS_SHOW) {
