...
import com.zw.filterrv.model.ZwFilterCheckData;
import com.zw.filterrv.model.ZwFilterCheckDataItem;
import com.zw.filterrv.model.ZwFilterData;
import com.zw.filterrv.seekbar.OnRangeChangedListener;
import com.zw.filterrv.seekbar.RangeSeekBar;
import com.zw.filterrv.utils.ListSortUtil;
...
public class FiltersDialog extends PopupWindow implements View.OnClickListener {
    ...
    private void resetAllItems()
    {
        ...
        mData.setSearchTxt("");
        mData.setSeekbarNum1End(0);
        mData.setSeekbarNum1Start(0);
        mData.setSeekbarNum2End(0);
        mData.setSeekbarNum2Start(0);
        mData.setTimeEnd(0);
        mData.setTimeStart(0);
        mData.setCheckDatas(checkDatas);
    }
